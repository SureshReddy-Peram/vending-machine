...
public class BeverageController {
    ...
    @RequestMapping(value = "/v1/add/beverage/", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/v1/get-beverages/", method = RequestMethod.GET)
    public ResponseEntity<StandardResponse> getBeverages() {
        return beverageService.getBeverages();
    }

    @RequestMapping(value = "/v1/place-order/", method = RequestMethod.POST)
